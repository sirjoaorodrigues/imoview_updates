...
workbook = xlsxwriter.Workbook('Imóveis com ERRO Complemento.xlsx')
...
def run_aplication():
    cont = 2
    f = open("codes/complemento.txt", "r")

    for i in f:
        driver.get(f'https://app.imoview.com.br/Imovel/Alterar/{i}')

        wdw(driver, 100).until(ec.element_to_be_clickable((By.XPATH, '//*[@id="complEnderec"]')))

        driver.find_element(By.XPATH,'//*[@id="complEnderec"]').send_keys('199')
