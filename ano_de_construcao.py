...
workbook = xlsxwriter.Workbook('Imóveis com ERRO ano de construção.xlsx')
...
def run_aplication():
    cont = 2
    f = open("codes/ano_de_construcao.txt", "r")

    for i in f:
        driver.get(f'https://app.imoview.com.br/Imovel/Alterar/{i}')

        wdw(driver, 100).until(ec.element_to_be_clickable((By.XPATH, '//*[@id="painelDatas"]/div/div[1]/div[1]/input')))

        driver.find_element(By.XPATH,'//*[@id="painelDatas"]/div/div[1]/div[1]/input').send_keys('2000')
