...
workbook = xlsxwriter.Workbook('Imóveis com ERRO IPTU.xlsx')
...
def run_aplication():
    cont = 2
    f = open("codes/IPTU.txt.", "r")

    for i in f:
        driver.get(f'https://app.imoview.com.br/Imovel/Alterar/{i}')

        wdw(driver, 100).until(ec.element_to_be_clickable((By.XPATH, '//*[@id="IptuImovel"]')))

        driver.find_element(By.XPATH,'//*[@id="IptuImovel"]').clear()
        driver.find_element(By.XPATH,'//*[@id="IptuImovel"]').send_keys('199,90')
